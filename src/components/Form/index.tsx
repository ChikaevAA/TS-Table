	...
	return (
		<form className={s.form} onSubmit={handleFormSubmit} onReset={toggleModal}>
			<Row>
				...
				<Cell>
					<Input dataType={inputTypes.number} dataValue={item.temperature}
						   onInputChange={(e) => handleInput(e)}/>
				</Cell>
				<Cell>
					<Input dataType={inputTypes.date} dataValue={item.discoveryDate}
						   onInputChange={(e) => handleInput(e)}/>
				</Cell>
				<Cell>
			...
			<Controls align='center'>
				<Button styleType="primary" buttonType="submit">Сохранить</Button>
				<Button styleType="danger" buttonType="reset">Отменить</Button>
